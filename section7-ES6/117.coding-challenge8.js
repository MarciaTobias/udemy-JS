...
function reportStreets(s) {
    ...
    // Average lenght
    const [totalLenght, avgLenght] = calc(s.map(el => el.lenght));
    console.log(`Our ${s.length} streets have a total lenght of ${totalLenght}km, with an average of ${avgLenght}`);
